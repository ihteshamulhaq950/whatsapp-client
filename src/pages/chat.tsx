...
const ChatPage: React.FC = () => {
    ...
    return (
        <>
            ...
            {/* `fixed top-0 bottom-0 xl:ml-12 ml-0 xl:w-[25%] lg:w-[30%] ${isHomePage ? 'w-[100%]' : 'lg:block hidden'} bg-white text-neutral-800 dark: bg-neutral-700 dark: text-white mt-2 overflow-y-scroll max-h-screen */}

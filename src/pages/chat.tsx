...
const ChatPage = () => {
    ...
    return (
        <>
            <div className="fixed top-0 left-0 bottom-0 flex flex-col justify-between items-center border py-4">
                <div className="flex flex-col">
                    <div className="flex justify-start items-center space-x-2 cursor-pointer hover:dark:bg-gray-800 py-2 px-2 mx-2">
                        {/* bars three */}
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center justify-start space-x-2 cursor-pointer hover:dark:bg-gray-800 py-2 px-2 mx-2">
                        {/* setting icon */}
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
            ...
            <aside className={`fixed top-0 left-36 lg:w-[27%] md:w-[47%] h-screen ${isHomePage ? 'w-[100%]' : 'md:block hidden'} bg-gray-50 dark:bg-neutral-800 text-gray-900 dark:text-white`}>
            ...
            <div className={`lg:ml-[27%] md:ml-[47%]  md:flex  ${isHomePage ? 'hidden items-center justify-center h-screen' : ''}  bg-white text-neutral-700 dark:bg-neutral-800 dark:text-white`}>
                <Outlet />
            </div>
        </>
    );

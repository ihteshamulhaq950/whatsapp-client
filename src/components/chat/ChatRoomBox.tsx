...
import audio from "../../../public/10secondaudio.mp3";
...
const ChatRoomBox = () => {
    ...
    return (
        <div className="bg-white dark:bg-neutral-800 h-screen w-full">
            ...
            {/* Chatbox Navbar */}
            <div className="bg-neutral-200 text-neutral-800 dark:bg-neutral-800 dark:text-neutral-100 w-full py-3 ps-5 pe-8 flex items-center justify-between space-x-2 border-b border-b-neutral-500">

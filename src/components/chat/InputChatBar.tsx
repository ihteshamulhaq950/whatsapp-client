...
const InputChatBar: React.FC = () => {
    return (
        <div className="sticky bottom-10 left-0 right-0 bg-gray-100 dark:bg-neutral-800/95  border-t border-neutral-600 p-4 flex space-x-2 items-center mx-1 shadow-md">
            {/* Attachment Icon */}
            <div>
                <AttachmentButton

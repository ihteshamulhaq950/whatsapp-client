...
interface IFileAttachmentChatProps {
    avatar: string;
    senderName: string;
    fileName: string;
    fileSize: string;
...
const FileAttachmentChat: React.FC<IFileAttachmentChatProps> = ({
    avatar,
    senderName,
    fileName,
    fileSize,
                    ...
                    <div className="flex items-start my-2.5 bg-gray-50 dark:bg-gray-600 rounded-xl p-2">
                        <div className="me-2">
                            ...
                            <span className="flex text-xs font-normal text-gray-500 dark:text-gray-400 gap-2">
                                {pages > 1 ? `${pages} pages` : `${pages} page`}
...
export default FileAttachmentChat
